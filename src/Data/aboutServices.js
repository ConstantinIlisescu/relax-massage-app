export const aboutServices = {
  ...
  sectionFour: {
    ...
    conclusionParagraph:
      "In conclusion, I aim to create a comfortable and relaxing environment for my clients, and provide them with the highest quality of massage services.",
    finalParagraph:
      "Please note that my services are strictly therapeutic and non-sexual in nature. Any requests for sexual services will not be tolerated and may result in termination of the massage session.",
  },
};
